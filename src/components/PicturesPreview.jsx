...
function ImageItem({ image }) {
  ...
  return (
    <div className="flex flex-col h-fit">
      <div className="relative grow w-full aspect-[3/2] rounded-r-xl rounded-l-[2rem] group-first/rounding:rounded-l-xl overflow-hidden ring-[16px] ring-white dark:ring-slate-900">
...
export function PicturesPreview({ images, href }) {
  ...
  return (
    <div className="not-prose my-4">
      <Link href={href}>
        <div className="group flex justify-start w-full h-[calc(14rem*2/3)] rounded-xl pr-0 lg:pr-4 xl:pr-0 cursor-pointer overflow-hidden">
